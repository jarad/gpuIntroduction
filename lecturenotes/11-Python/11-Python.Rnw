...
/home/landau
[landau@impact1 ~]$ ls
gpuIntroduction  gpuRejectionSampling  Ideas  Masters_Project  Python  R
[landau@impact1 ~]$ wget http://prdownloads.sourceforge.net/sqlalchemy/SQLAlchemy-0.7.9.tar.gz?download
# output of wget ...
[landau@impact1 ~]$ ls
gpuIntroduction  gpuRejectionSampling  Ideas  Masters_Project  Python  R  SQLAlchemy-0.7.9.tar.gz
[landau@impact1 ~]$ tar -zxvf SQLAlchemy-0.7.9.tar.gz 
# output of tar...
[landau@impact1 ~]$ cd SQLAlchemy-0.7.9
[landau@impact1 SQLAlchemy-0.7.9]$ ls
CHANGES              doc          lib          PKG-INFO     README.unittests  setup.py
CHANGES_PRE_06       examples     LICENSE      README.py3k  sa2to3.py         sqla_nose.py
distribute_setup.py  ez_setup.py  MANIFEST.in  README.rst   setup.cfg         test
