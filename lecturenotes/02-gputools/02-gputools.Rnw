...
The R script, {\tt perf\_gpuQr.r}, compares the performance of {\tt gpuQr(x)} and {\tt qr(x)} for matrices {\tt x} of varying sizes. See the results on the next few slides.

\newpage

\setkeys{Gin}{width=.9\textwidth} \includegraphics[scale=0.25,angle=0]{performance_gpuQr_user} \newpage
\setkeys{Gin}{width=.9\textwidth} \includegraphics[scale=0.25,angle=0]{performance_gpuQr_syst} \newpage
\setkeys{Gin}{width=.9\textwidth} \includegraphics[scale=0.25,angle=0]{performance_gpuQr_total} \newpage
...
%The R script, {\tt perf\_gpuSvd.r}, compares the performance of {\tt gpuSvd(x)} and {\tt svd(x)} for matrices {\tt x} of varying sizes. See the results on the next few slides.
...
%The R script, {\tt perf\_gpuLm.r}, compares the performance of {\tt gpuLm(y ~ x)} and {\tt lm(y ~ x)} for matrices {\tt y} and {\tt x} of varying sizes. See the results on the next few slides.

%\newpage

%\setkeys{Gin}{width=.9\textwidth} \includegraphics[scale=0.25,angle=0]{performance_gpuLm_user} \newpage
%\setkeys{Gin}{width=.9\textwidth} \includegraphics[scale=0.25,angle=0]{performance_gpuLm_syst} \newpage
%\setkeys{Gin}{width=.9\textwidth} \includegraphics[scale=0.25,angle=0]{performance_gpuLm_total} \newpage
...
%The R script, {\tt perf\_gpuGlm.r}, compares the performance of {\tt gpuGlm(y ~ x)} and {\tt glm(y ~ x)} for matrices {\tt y} and {\tt x} of varying sizes. See the results on the next few slides.

%\newpage

%\setkeys{Gin}{width=.9\textwidth} \includegraphics[scale=0.25,angle=0]{performance_gpuGlm_user} \newpage
%\setkeys{Gin}{width=.9\textwidth} \includegraphics[scale=0.25,angle=0]{performance_gpuGlm_syst} \newpage
%\setkeys{Gin}{width=.9\textwidth} \includegraphics[scale=0.25,angle=0]{performance_gpuGlm_total} \newpage
